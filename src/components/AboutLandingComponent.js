                    ...
                    <Grid xs={4} className="landing-grid">
                        ...
                        <div className="banner-text" style={{ padding: "0px" }}>
                            ...
                            <p style={{ fontSize: "95%", textAlign: "left" }}>
                                ...
                                that exist within each of the major media news outlets available. Thanks to the <a href="https://newsapi.org" style={{ color: "lavender" }}>NewsApi.org</a>, Purple Pundit currently features over 50 media sources including
                            CNN, MSNBC, Fox News, The Washington Times, amongst others. The color that determines the political bias of each of the sources is determined by the
                                <a href="https://mediabiasfactcheck.com/" style={{ color: "lavender" }}> Media Bias Fact Checker</a>.
                            </p>
                            <p style={{ fontSize: "95%", textAlign: "left", paddingTop: "5%" }}>
                                In an age in which effective political discussion is often held to a minimum
